...
namespace E_commers_project.Migrations
{
    ...
    [Migration("20241101215313_eCommerce")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_commers_project.Data.Sellers", b =>
                {
                    ...
                    b.Property<int>("Seller_creadcard")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SellersUsers", b =>
                {
                    b.Property<int>("SellersSellerId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SellersSellerId", "UsersUserId");

                    b.HasIndex("UsersUserId");

                    b.ToTable("SellersUsers");
                });
            ...
            modelBuilder.Entity("ProductsUsers", b =>
                {
                    b.HasOne("E_commers_project.Data.Products", null)
                        .WithMany()
                        .HasForeignKey("ProductsProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_commers_project.Data.Users", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SellersUsers", b =>
                {
                    b.HasOne("E_commers_project.Data.Sellers", null)
                        .WithMany()
                        .HasForeignKey("SellersSellerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
